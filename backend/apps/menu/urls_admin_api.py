...
urlpatterns = [
    ...
    path('weekly/<int:weekday>/', portal_api.weekday_template_detail, name='weekday_template'),
    path('daily/', portal_api.upcoming_daily_menus, name='upcoming_daily'),
    path('daily/<int:year>/<int:month>/<int:day>/', portal_api.daily_menu_detail, name='daily_menu_detail'),
]
